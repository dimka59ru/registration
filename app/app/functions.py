...
def send_email(number_of_project, add_date, email_to, file):
    ...
    <html>
      ...
      <p>Добрый день!</p>
        ...
        Если данный проект актуален - необходимо прислать скан заявки снова.
        Форма заявки на регистрацию проекта - по ссылке <a href="http://www.tfortis.ru/upload/Форма_заявки_на_регистрацию_проекта.xlsx">http://www.tfortis.ru/upload/Форма_заявки_на_регистрацию_проекта.xlsx</a>.
        </p>
        <hr/>
        <p>С уважением,<br/>
        Оксана Абрамова<br/>       
